...
Spark play on Focus and My Sprite: poke a side, boop the face, scrunch the twin peaks, double-tap to spin, drag across the belly to tickle, wave the cursor nearby for a mirrored pose, long-press to sleep, feed a snack, catch a mint star, and drag an owned cosmetic from the tray onto Spark to equip. My Sprite ⓘ lists the short cheat sheet. Focus can sit Spark beside the timer (study buddy sit). No random high-fives.
...
8. `/unlocks` — the one dedicated Unlocks route (linked from Home and Focus only). Notes is not an unlock. Day-to-day spend is the Home App unlocks card (Tier 2 at 5 tokens / 10 min, Tier 3 nemesis set at 10). Focus has a compact, hideable panel. The token pill jumps to Home.
