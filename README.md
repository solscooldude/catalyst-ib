...
10. `/appearance` — closet collections (rooms parked). Starter trails include paper dust, mint vapor, and basic sparkle. Night sky and elite gold stay. Lamp ember trail remains. Focus is a large spark on a quiet stage (pet, wander, morph, loop, rare +1 token). `/sprite` is My Sprite.
