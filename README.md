...
10. `/appearance` — four collections. Starter: cheap accents, tints, pink bow, black glasses, red scarf, dark cap, basic sparkle trail. Night sky (80–150): Stars, Aurora, aurora veil, aurora spark tint, aurora trail. Elite gold (200–350): gold accent, gilded cap, gold sparkle trail. Focus scenes: Rocket to space (120) is one timer theme among others — liftoff into the open universe. The spark grows and glows from lifetime official study hours. Tap it on the dashboard to pet it. Rare idle popups use your saved IB subjects.
